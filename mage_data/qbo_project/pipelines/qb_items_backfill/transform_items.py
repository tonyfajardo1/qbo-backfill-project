"""
Transformer: Valida y prepara Items para carga
...
@transformer
def transform_items(data: List[Dict[str, Any]], *args, **kwargs) -> List[Dict[str, Any]]:
    """Valida y transforma los registros de Items."""
    print("=" * 60)
    print("TRANSFORMACION Y VALIDACION DE ITEMS")
    print("=" * 60)
